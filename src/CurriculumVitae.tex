...
\newcolumntype{L}[1]{>{\raggedleft}p{#1\textwidth}}
\newcolumntype{R}[1]{p{#1\textwidth}}
...
\newcommand*\commasep[2][, ]{%
	...
	\def\commasependsep{\space#2\space}%  store last separator e.g. 'and'
	\@commasep
}
...
%================================================%
% \professionalExperience{startEmploymentPeriod}{endEmploymentPeriod}{position}{company}{jobDescription}{tools}
%================================================%
\newcommand{\professionalExperience}[6]{%
...
\begin{tabular}{>{\bfseries}L{0.3}!{\VRule}R{0.64}}
...
\global\def \lwidth{0.16\textwidth}
\global\def \rwidth{0.78\textwidth}
...
\subsection*{Licenses}
\begin{longtable}{>{\bfseries}L{0.16}!{\VRule}R{0.78}}
