...
\usepackage[showgrades,showtools]{cvtools} % my CV styling stuff
...
{
\professionalTool{Oracle database management system}
\professionalTool{Visual Basic for Applications (VBA)}
\professionalTool{SQL}
}
...
\qualification{April 2010}{Safety Checking Electrical Appliances}
{TAFE Statement in \qualificationName{Safety Checking Electrical Appliances}.}

\qualification{2 December 2008}{Responsible Service of Alcohol}
{Statement of Attainment for fulfilling the requirements of 
...
\qualification{26 February 2008}{Turning Shoppers into Buyers}
...
\qualification{5 July 2007}{Defensive Driving}
