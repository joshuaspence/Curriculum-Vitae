...
\usepackage{commasep}				% for comma-separated lists
\usepackage[inline]{enumitem} 		% for tweaking lists
\usepackage{etoolbox} 				% for \ifstrempty, \ifdef
...
% CONFIGURATION
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Show the tools used at each previous job
\newboolean{showTools}
\setboolean{showTools}{false}

% Show the grades from my education
\newboolean{showGrades}
\setboolean{showGrades}{true}
%------------------------------------------------------------------------------%
...
% \personalDetailsItemWithSpace{itemName}{itemValue}{spacing}
% \end{personalDetails}
%================================================%
...
%================================================%
% \begin{education}
% \educationItem{beginYear}{endYear}{name}{institution}{grades}
% \end{education}
%================================================%
...
\begin{professionalExperience}
\begin{comment}
% Software Engineering Graduate (Reserve Bank of Australia)
\professionalExperience{February 2013}{present}
{Software Engineering Graduate}{Reserve Bank of Australia}
{TODO}
{}
\end{comment}
...
Through this position, I have gained a wide range of experience including 
website administration, Unix administration and designing and building dedicated
Unix servers.}
{
\item Ubuntu Server
\item Sun Solaris
...
sophisticated temporal SQL queries.}
{
...
{Industrial Student}{Australian Energy Market Operator}
{I was working in the Metering \& Settlements team. This team had to deal with 
large amounts of data existing in SQL tables which are updated hourly based on 
...
{Industrial Student}{Energy Australia}
{In this role, I was involved with the `Intelligent Networks' division, working 
on an electrical sensing and monitoring system. I was involved with analysing 
system diagrams and attending regular meetings with engineers to discuss 
implementation details for a smart metering device that was being developed.
